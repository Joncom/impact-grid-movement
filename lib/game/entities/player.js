...
.defines(function() {
    ...
    EntityPlayer = ig.Entity.extend({
        ...
        update: function() {
            ...
            else if(destination && this.justReachedDestination() && this.moveIntention && this.moveIntention === this.lastMove) this.continueMovingFromDestination();
            ...
            else if(destination && !this.justReachedDestination()) { this.continueMovingToDestination(); }
