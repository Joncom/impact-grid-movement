...
.defines(function() {
    ...
    EntityPlayer = ig.Entity.extend({
        ...
        update: function() {
            ...
            if(destination && this.justReachedDestination() && !this.moveIntention) this.stopMoving();
            ...
            else if(destination && this.justReachedDestination() && this.moveIntention && this.moveIntention !== this.lastMove) this.changeDirectionAndContinueMoving(this.moveIntention);
            else if(destination && !this.justReachedDestination()) { this.continueMoving(); }
            else if(!destination && this.moveIntention && this.canMoveDirection(this.moveIntention)) this.startMoving(this.moveIntention);
        ...
        getAdjacentTile: function(direction) {
            var tilesize = ig.game.collisionMap.tilesize;
            var tileX = this.pos.x / tilesize;
            var tileY = this.pos.y / tilesize;
        ...
        startMoving: function(direction) {
            // Get new destination.
            this.destination = this.getAdjacentTile(direction);
            // Move.
        ...
        continueMovingFromDestination: function() {
            // Get new destination.
            this.destination = this.getAdjacentTile(newDirection); // TODO: SNAP BEFORE CAL'C
            // Move.
            this.setVelocityByTile(this.destination.x, this.destination.y, this.speed);
        },
        ...
        changeDirectionAndContinueMoving: function(newDirection) {
            ...
            // Get new destination.
            this.destination = this.getAdjacentTile(newDirection);
            // Move.
            this.setVelocityByTile(this.destination.x, this.destination.y, this.speed);
        },
