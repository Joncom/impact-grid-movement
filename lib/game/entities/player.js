...
.defines(function() {
    ...
    EntityPlayer = ig.Entity.extend({
        ...
        update: function() {
            ...
            if(destination && this.reachedOrPassedDestination() && !this.moveIntention) { /* align to grid and stop */ }
            else if(destination && this.reachedOrPassedDestination() && this.moveIntention && this.moveIntention === this.lastMove) { /* continue moving same direction */ }
            else if(destination && this.reachedOrPassedDestination() && this.moveIntention && this.moveIntention !== this.lastMove) { /* align to grid and start moving in new direction */ }
            else if(destination && !this.reachedOrPassedDestination()) { /* continue moving in same direction */ }
        ...
        reachedOrPassedDestination: function() {
            var tilesize = ig.game.collisionMap.tilesize;
