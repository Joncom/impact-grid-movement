...
.defines(function() {
    ...
    EntityPlayer = ig.Entity.extend({
        ...
        update: function() {
            ...
            else if(this.destination && this.justReachedDestination() && this.moveIntention && this.moveIntention === this.lastMove) this.continueMovingFromDestination();
            else if(this.destination && this.justReachedDestination() && this.moveIntention && this.moveIntention !== this.lastMove) this.changeDirectionAndContinueMoving(this.moveIntention);
            else if(this.destination && !this.justReachedDestination()) { this.continueMovingToDestination(); }
            else if(!this.destination && this.moveIntention && this.canMoveDirection(this.moveIntention)) this.startMoving(this.moveIntention);
            else if(!this.destination && this.moveIntention && !this.canMoveDirection(this.moveIntention)) { /* do nothing */ }
        ...
        canMoveDirection: function(direction) {
            var currPos = this.getTilePos();
            var newPos = this.getTileAdjacentToTile(currPos.x, currPos.y, direction);
