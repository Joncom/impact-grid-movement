...
.defines(function() {
    ...
    EntityPlayer = ig.Entity.extend({
        ...
        justReachedDestination: function() {
            return (
                ((this.pos.x >= this.desination.x && this.last.x < this.desination.x) || (this.pos.x <= this.desination.x && this.last.x > this.desination.x)) &&
                ((this.pos.y >= this.desination.y && this.last.y < this.desination.y) || (this.pos.y <= this.desination.y && this.last.y > this.desination.y))
            );
        },
